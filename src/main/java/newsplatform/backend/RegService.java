...
import newsplatform.backend.Repository.CommentRepository;
import newsplatform.backend.Repository.NewsRepository;
...
public class RegService {
    @Autowired
    newsplatform.backend.Repository.UserRepository UserRepository;
    @Autowired
